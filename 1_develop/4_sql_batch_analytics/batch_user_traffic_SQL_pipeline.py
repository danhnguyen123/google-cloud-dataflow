...
# export TABLE_NAME=${PROJECT_ID}:logs.user_traffic_sql
# export AGGREGATE_TABLE_NAME=${PROJECT_ID}:logs.user_traffic_sql
# export RAW_TABLE_NAME=${PROJECT_ID}:logs.raw_sql
