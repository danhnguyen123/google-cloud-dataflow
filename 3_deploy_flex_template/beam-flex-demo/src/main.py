...
logger = LoggingHelper.get_configured_logger("my-logger")
...
def run():
    ...
    options.view_as(GoogleCloudOptions).job_name = '{0}{1}'.format('flex-template-branching-pipeline-',time.time_ns())
